...
def load_data():
    ...
    and return it.
    """
    file = "D:\\Users\\tinaf\\Dropbox\\CMU\\1-Course-Related\\##S22##\\05839_interactive_ds\\hw\\hw2\\billionaires.csv"
    df = pd.read_csv(file)
    return df

def geo_data():
    file = "D:\\Users\\tinaf\\Dropbox\\CMU\\1-Course-Related\\##S22##\\05839_interactive_ds\\hw\\hw2\\df_ag.csv"
    df = pd.read_csv(file)
    return df
